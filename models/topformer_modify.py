...
@manager.BACKBONES.add_component
def TopTransformer_Large(**kwargs):
    cfgs = [
        # k,  t,  c, s
        [3, 1, 16, 1],  # 1/2
        [3, 4, 32, 2],  # 1/4 1
    ...
    model = TopTransformer(
        cfgs=cfgs,
        injection_out_channels=[None, 512, 512, 512],
        encoder_out_indices=[2, 4, 6, 9],
        trans_out_indices=[1, 2, 3],
        depths=4,
        key_dim=16,
...
if __name__ == '__main__':
    model = TopTransformer_Base(lr_mult=0.1)
