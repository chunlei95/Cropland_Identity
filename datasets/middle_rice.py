...
from datasets.transforms.transforms import MultiSpectralCompose


@manager.DATASETS.add_component
class MiddleSeasonRiceDataset(paddle.io.Dataset):
    NUM_CLASSES = 2
    ...
    def __init__(self,
        ...
        self.transforms = MultiSpectralCompose(transforms)
